    ...
    >
      ...
      <div>
        ...
        <textarea
          ...
          className={`w-full px-4 py-2 border-2 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-shadow min-h-[120px] resize-y text-gray-900 ${
